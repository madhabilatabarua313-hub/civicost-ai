...
def generate_pdf(project_title, summary_data):
    ...
    # Header Section
    pdf.cell(0, 10, clean_text("CiviCost AI - Structural Estimation Report"), new_x="LMARGIN", new_y="NEXT", align="C")
    pdf.set_font("Helvetica", "", 11)
    pdf.cell(0, 8, clean_text(f"Category: {project_title}"), new_x="LMARGIN", new_y="NEXT", align="C")
    pdf.ln(5)

    # Table Header
    pdf.set_font("Helvetica", "B", 11)
    pdf.set_fill_color(230, 230, 230)
    pdf.cell(100, 8, clean_text("Item Description"), border=1, fill=True)
    pdf.cell(90, 8, clean_text("Value / Cost"), border=1, new_x="LMARGIN", new_y="NEXT", fill=True)

    # Table Content
    pdf.set_font("Helvetica", "", 10)
    for key, value in summary_data.items():
        pdf.cell(100, 8, clean_text(key), border=1)
        pdf.cell(90, 8, clean_text(value), border=1, new_x="LMARGIN", new_y="NEXT")

    pdf.ln(10)
    pdf.set_font("Helvetica", "I", 9)
    pdf.cell(0, 8, clean_text("Generated by CiviCost AI - Civil Engineering Assistant"), align="R")
